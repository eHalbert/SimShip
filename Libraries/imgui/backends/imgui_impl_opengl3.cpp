...
//  [x] Renderer: Large meshes support (64k+ mvVertices) with 16-bit mvIndices (Desktop OpenGL only).
...
//  2023-03-23: OpenGL: Properly restoring "no mShader program bound" if it was the case prior to running the rendering function. (#6267, #6220, #6224)
...
//  2021-08-23: OpenGL: Fixed ES 3.0 mShader ("#version 300 es") use normal precision floats to avoid wobbly rendering at HD resolutions.
//  2021-08-19: OpenGL: Embed and use our own minimal GL loader (imgui_impl_opengl3_loader.h), removing requirement and support for third-party loader.
//  2021-06-29: Reorganized backend to pull data from a single structure to facilitate usage with multiple-contexts (all g_XXXX access changed to bd->XXXX).
//  2021-06-25: OpenGL: Use OES_vertex_array extension on Emscripten + backup/restore current state.
//  2021-06-21: OpenGL: Destroy individual vertex/fragment mShader objects right after they are linked into the main mShader.
...
//  2019-05-29: OpenGL: Desktop GL only: Added support for large mesh (64K+ mvVertices), enable ImGuiBackendFlags_RendererHasVtxOffset flag.
...
//  2018-01-07: OpenGL: Changed GLSL mShader version from 330 to 150.
