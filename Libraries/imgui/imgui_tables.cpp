...
void ImGui::TableUpdateLayout(ImGuiTable* table)
{
    ...
    // Process columns in their visible orders as we are building the Prev/Next mvIndices.
...
void    ImGui::EndTable()
{
    ...
    // Cons: making it harder for users watching metrics/debugger to spot the wasted mvVertices.
